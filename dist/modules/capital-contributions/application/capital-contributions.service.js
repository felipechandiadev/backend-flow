...
exports.CapitalContributionsService = void 0;
...
let CapitalContributionsService = class CapitalContributionsService {
    ...
    async create(payload) {
        ...
        try {
            const createTxDto = new create_transaction_dto_1.CreateCapitalContributionDto();
            ...
            return {
                success: false,
                error: `Error al crear aporte: ${err.message}`,
            };
        }
    }
    asString(value) {
...
exports.CapitalContributionsService = CapitalContributionsService;
exports.CapitalContributionsService = CapitalContributionsService = __decorate([
...
//# sourceMappingURL=capital-contributions.service.js.map