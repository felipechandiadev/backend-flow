...
exports.BankWithdrawalsService = void 0;
...
let BankWithdrawalsService = class BankWithdrawalsService {
    ...
    async create(payload) {
        ...
        try {
            const createTxDto = new create_transaction_dto_1.CreateBankWithdrawalToShareholderDto();
            ...
            return {
                success: false,
                error: `Error al crear retiro: ${err.message}`,
            };
        }
    }
    asString(value) {
...
exports.BankWithdrawalsService = BankWithdrawalsService;
exports.BankWithdrawalsService = BankWithdrawalsService = __decorate([
...
//# sourceMappingURL=bank-withdrawals.service.js.map