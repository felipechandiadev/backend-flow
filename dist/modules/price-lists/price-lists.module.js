...
exports.PriceListsModule = PriceListsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([price_list_entity_1.PriceList])],
        controllers: [price_lists_controller_1.PriceListsController],
        providers: [price_lists_service_1.PriceListsService],
        exports: [price_lists_service_1.PriceListsService],
    })
], PriceListsModule);
