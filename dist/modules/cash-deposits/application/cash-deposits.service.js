...
exports.CashDepositsService = void 0;
...
let CashDepositsService = class CashDepositsService {
    ...
    async create(payload) {
        ...
        try {
            const createTxDto = new create_transaction_dto_1.CreateCashDepositDto();
            ...
            return {
                success: false,
                error: `Error al crear depósito: ${err.message}`,
            };
        }
    }
    asString(value) {
...
exports.CashDepositsService = CashDepositsService;
exports.CashDepositsService = CashDepositsService = __decorate([
...
//# sourceMappingURL=cash-deposits.service.js.map