...
__decorate([
    (0, class_validator_1.IsEnum)(person_entity_1.PersonType),
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => (typeof value === 'string' && value.trim() === '' ? undefined : value)),
    (0, class_validator_1.IsEnum)(person_entity_1.DocumentType),
    __metadata("design:type", String)
...
__decorate([
    ...
    __metadata("design:type", Number)
], CreateCustomerDto.prototype, "paymentDayOfMonth", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => (typeof value === 'string' && value.trim() === '' ? undefined : value)),
    (0, class_validator_1.IsString)(),
