...
let ShareholdersService = class ShareholdersService {
    constructor(shareholderRepository) {
    ...
    async listShareholders() {
        try {
            ...
            return (shareholders || []).map((shareholder) => {
                ...
                const displayName = shareholder.person.businessName?.trim() ||
...
exports.ShareholdersService = ShareholdersService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(shareholder_entity_1.Shareholder)),
